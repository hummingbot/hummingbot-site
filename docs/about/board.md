...
Hummingbot Foundation re-elects its Board of Directors every 12 months via Governance Proposal, following a process similar to that of other [Polls](../governance/polls.md):
...
* **Election starts**: We will create the election as a [Hummingbot Governance Proposal](../governance/proposals.md) with everyone who applied via the Discord thread. Similar to other polls, this election uses Snapshot gasless voting and the quadratic voting allocation method.
