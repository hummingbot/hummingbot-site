...
Fast forward to October, and I wanted to test out the new V2 strategy framework, notable for creating [Executors](../../../strategies/v2-strategies/executors/index.md) instead of orders. This innovative approach is based on the [triple barrier method](../../../strategies/v2-strategies/executors/positionexecutor.md#the-triple-barrier-method), a concept from [Advances in Financial Machine Learning](https://www.wiley.com/en-us/Advances+in+Financial+Machine+Learning-p-9781119482086) by Marcos López de Prado.
