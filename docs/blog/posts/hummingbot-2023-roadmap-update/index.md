...
1. Expanded Hummingbot to directional strategies by introducing the [Candles Feed](../../../strategies/v2-strategies/candles/index.md) OHLCV generator and the [PositionExecutor Smart Component](../../../strategies/v2-strategies/executors/index.md), enhancing the efficiency and flexibility of our trading algorithms
