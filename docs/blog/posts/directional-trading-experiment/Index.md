...
Our strategy employs the Directional Framework, which combines two novel features in Hummingbot: [Candles Feed](../../../v2-strategies/candles/index.md) and [PositionExecutor](../../../v2-strategies/executors/positionexecutor.md).
