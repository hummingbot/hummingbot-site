...
Additionally, this feature does not account for rewards earned through Hummingbot’s new liquidity bounties program. This means that gains may be higher than accounted for. Finally, while this feature currently only reports one figure for overall trade performance, future releases of Hummingbot may report profitability for individual trades.
