...
Almost exactly one year ago, Hummingbot Foundation [launched the HBOT token](../2021-12-introducing-hbot/index.md) as an experiment in decentralized governance over a publicly shared, community maintained open source project.
