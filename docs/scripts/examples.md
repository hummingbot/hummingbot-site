...
These are a collection of older scripts which are moved over to the [archived_scripts](https://github.com/hummingbot/hummingbot/tree/master/scripts/archived_scripts) folder in the Github repo.
