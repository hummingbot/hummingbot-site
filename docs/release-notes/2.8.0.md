...
**Standardized Schemas**: Implemented three universal trading schemas across all DEX connectors:
  ...
  - [**Router Schema**](../gateway/connectors.md#router-schema): DEX aggregators (Jupiter, 0x, Uniswap Router) that find optimal swap routes
  - [**AMM Schema**](../gateway/connectors.md#amm-schema): Traditional V2-style constant product pools (Raydium AMM, Uniswap V2)
  - [**CLMM Schema**](../gateway/connectors.md#clmm-schema): V3-style concentrated liquidity pools (Meteora DLMM, Raydium CLMM, Uniswap V3)
...
**New Configuration System**: 
  ...
  - See [Configuration Guide](../gateway/configuration.md) for details

#### 🎮 Gateway Commands in Hummingbot

Added comprehensive [Gateway commands](../gateway/commands.md) directly in the Hummingbot client:
...
* **[Jupiter](../exchanges/gateway/jupiter.md)**: Complete rewrite with Router schema, improved route finding and error handling
* **[Meteora](../exchanges/gateway/meteora.md)**: New DLMM (Dynamic Liquidity Market Maker) support with CLMM schema
* **[Raydium](../exchanges/gateway/raydium.md)**: Dual support for AMM V2 pools and CLMM V3 concentrated liquidity
* **[Uniswap](../exchanges/gateway/uniswap.md)**: Migrated to Universal Router with support for V2 AMM, V3 CLMM, and Smart Order Router
...
* **[PancakeSwap](../exchanges/gateway/pancakeswap.md)** - BNB Chain AMM/CLMM ([Bounty #7654](https://github.com/hummingbot/hummingbot/issues/7654))
* **[Balancer](../exchanges/gateway/balancer.md)** - Multi-asset AMM pools ([Bounty #7653](https://github.com/hummingbot/hummingbot/issues/7653))
* **[Curve](../exchanges/gateway/curve.md)** - Stablecoin-optimized AMM ([Bounty #7652](https://github.com/hummingbot/hummingbot/issues/7652))
* **[SushiSwap](../exchanges/gateway/sushiswap.md)** - Multi-chain AMM/CLMM
* **[QuickSwap](../exchanges/gateway/quickswap.md)** - Polygon AMM/CLMM
* **[TraderJoe](../exchanges/gateway/traderjoe.md)** - Avalanche AMM/CLMM
* **[ETCSwap](../exchanges/gateway/etcSwap.md)** - Ethereum Classic AMM

See the [DEX Connectors](../gateway/connectors.md) page for full details on upgrading these connectors to the v2.8.0 standard. 
...
* **[Gateway Documentation](../gateway/index.md)**: Complete rewrite with practical guides and examples
* **[Gateway Strategies](../gateway/strategies.md)**: New scripts demonstrating AMM Data Feed, AMM Trade, and LP Position Management
* **[Chain Schemas](../gateway/chains.md#chain-schema)**: Standardized request/response schemas for all blockchain operations

#### 🚀 Migration Guide

For users upgrading from Gateway v2.7 or earlier, see the [Gateway Installation Guide](../gateway/installation.md) for complete setup instructions.
...
- Based on approval from [community voting](https://snapshot.box/#/s:hbot-ncp.eth/proposal/0x01022a516c3536d015e21b28e90204a7dbc4a65b42c0e2d568847509f7531e6a), the [Foxbit](../exchanges/foxbit/index.md) exchange connector was added back in [#7680](https://github.com/hummingbot/hummingbot/pull/7680).
