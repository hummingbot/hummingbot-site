...
- [Candles Feed](/v2-strategies/candles/): Custom OHLCV candles using both historical and live Websocket data
- [Cheatsheet](/scripts/cheatsheet/): Reference for creating Scripts
- [Smart Components](/v2-strategies/candles/): Self-executing, encapsulated piece of logic like `PositionExecutor`
