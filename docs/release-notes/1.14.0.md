...
We have streamlined and simplified the [Installation](../installation/hummingbot-client.md) section, adding OS-specific guides and [a new Docker page](../installation/hummingbot-client.md) that explains how to deploy various Hummingbot configurations using Docker.
...
- [Cheatsheet](../strategies/scripts/cheatsheet.md): Reference for creating Scripts
...
We improved the [PositionExecutor](../strategies/v2-strategies/executors/positionexecutor.md) Smart Component introduced in the last release:
