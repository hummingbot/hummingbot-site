...
We have streamlined and simplified the [Installation](/installation) section, adding OS-specific guides and [a new page](/installation/deploy) that explains how to deploy various Hummingbot configurations using Docker.
