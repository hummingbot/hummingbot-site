...
Also, see the new [Bounty Pricing Guidance](../bounties/lifecycle.md) page as a guideline to make it easier for both developers and sponsors to agree on a price for external bounties. 
...
- [#6791](https://github.com/hummingbot/hummingbot/pull/6791) - Added [OKX Perpetuals](../exchanges/okx/index.md) candles feed **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#6796](https://github.com/hummingbot/hummingbot/pull/6796) - Renamed Huobi to [HTX](../exchanges/htx/index.md) **Thanks to [blagodar1](https://github.com/blagodar1) for this fix! 🙏**
