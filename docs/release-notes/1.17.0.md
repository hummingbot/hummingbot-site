...
This release includes the refactoring of the Position Executor in Hummingbot. The key changes include:
...
The following are connectors and strategies removed from the Hummingbot codebase that didnt pass quorum in the previous Epoch 4 polls. Check the poll results here - https://blog.hummingbot.org/epoch-4-polls-recap/

- Removed Hotbit connector

**Pull Requests:** [#6359](https://github.com/hummingbot/hummingbot/pull/6359)

**Snapshot Proposal:**  [HIP-25 Remove Hotbit connector](https://snapshot.org/?ref=blog.hummingbot.org#/hbot-ip.eth/proposal/0x5476dee9c99fc1a9b65ba1616f01a0304244791c147bf0f90a02361c7b52f795)

- Removed Aaroon Oscilator

**Pull Requests:** [#6358](https://github.com/hummingbot/hummingbot/pull/6358)

**Snapshot Proposal:** [HGP-39 Epoch 4 Core Strategies Poll](https://snapshot.org/?ref=blog.hummingbot.org#/hbot.eth/proposal/0x2f7646e3ad8db1746fc3158cbad8c1b46ee5736465becc5449a4341b2254b2c3)

- Removed CI EX

**Pull Requests:** [#6371](https://github.com/hummingbot/hummingbot/pull/6371)

**Snapshot Proposal:** [HGP-37 Epoch 4 CEX connectors poll](https://snapshot.org/?ref=blog.hummingbot.org#/hbot.eth/proposal/0xc130b4466d90ebf68da68b26c1e800678e358f81dc142ae888546e44c227d655)
