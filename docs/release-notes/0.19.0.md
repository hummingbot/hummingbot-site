...
* Added detailed examples to [Building Connectors](https://hummingbot.org/developers/connectors/#exchange-connector-requirements) in using aioconsole for testing.
