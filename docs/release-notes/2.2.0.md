...
Users can now use the Arbitrage Controller (see below) or the [AMM arbitrage](../strategies/amm-arbitrage.md) V1 strategy to run arbitrage strategies between Jupiter and other Hummingbot-supported exchanges. See the [Jupiter](../exchanges/gateway/jupiter.md) documentation for more information.
