...
- [#7002](https://github.com/hummingbot/hummingbot/pull/7002) - Fixed issue with [OKX Perpetual](../exchanges/okx/index.md) orders with wrong amount **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
...
- [#7022](https://github.com/hummingbot/hummingbot/pull/7022) - Added [OKX](../exchanges/okx/index.md) spot candles feed **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this contribution! 🙏**
