...
- [Bitget](../exchanges/bitget/index.md) is a centralized cryptocurrency exchange established in 2018 and is registered in Singapore. Bitget is one of the world’s leading cryptocurrency exchanges with a core focus on social trading.

See the [Bitget](../exchanges/bitget/index.md) documentation for more information.
...
Each cohort of [Hummingbot Botcamp](https://www.botcamp.xyz/), our new intensive 4-week bootcamp that teaches students how to create custom trading strategies as simple Hummingbot scripts, will add more examples into the codebase.
