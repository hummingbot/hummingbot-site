...
- BNB Chain: [PancakeSwap](../exchanges/pancakeswap.md) and [SushiSwap](../exchanges/sushiswap.md)
- Cronos: [VVS Finance](../exchanges/vvs.md) and [MM Finance](../exchanges/mad-meerkat.md)
