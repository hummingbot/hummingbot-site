...
Hummingbot has evolved from a simple market making bot into a powerful generalized framework for building any automated trading stategy on any CEX or DEX. Hummingbot codebase now features examples of [12 different scripts](../strategies/scripts/examples.md) that you can customize and run using Hummingbot.
...
All scripts examples can be found [here](../strategies/scripts/examples.md).
