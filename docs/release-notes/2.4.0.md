...
- [#7315](https://github.com/hummingbot/hummingbot/pull/7315) - Updated [Bitmart](../exchanges/bitmart/index.md) to latest API version  **Thanks to [babcoccl](https://github.com/babcoccl) for this fix! 🙏**
- [#7421](https://github.com/hummingbot/hummingbot/pull/7421) - Fixed `last_price` bug in [Dexalot](../exchanges/dexalot.md)  **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#7441](https://github.com/hummingbot/hummingbot/pull/7441) - Updated [Bybit](../exchanges/bybit.md) to latest API version **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#7442](https://github.com/hummingbot/hummingbot/pull/7442) - Updated [Bitmart](../exchanges/bitmart/index.md) ticker parsing  **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#7448](https://github.com/hummingbot/hummingbot/pull/7448) - Updated [Injective](../exchanges/injective.md) library version to 1.8  **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
