...
For more details of the Epoch 3 poll results check out this [blog post](https://hummingbot.org/blog/posts/epoch-3-polls-recap/).
...
See the [Gateway Setup](../gateway/installation.md) documentation page for more information on how to approve tokens.
