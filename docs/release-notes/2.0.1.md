...
Authentication is disabled by default. However, if you want to enable it, follow the **[Authentication](../blog/posts/quickstart-dashboard/index.md#authentication)** steps in the Dashboard Quickstart.
