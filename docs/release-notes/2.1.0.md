...
This release introduces a fully Python-based implementation of the [Dexalot](../exchanges/dexalot.md) connector, removing the Gateway dependency in [#7219](https://github.com/hummingbot/hummingbot/pull/7219). Users can now:
...
- Based on approval from community voting, the [Tegro](../exchanges/tegro/index.md) exchange connector was added in [#7148](https://github.com/hummingbot/hummingbot/pull/7148).
