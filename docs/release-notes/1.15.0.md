...
* DockerHub: [`version-1.15.0`](https://hub.docker.com/r/hummingbot/hummingbot/tags?name=version-1.15.0) | [`version-1.15.0-arm_beta`](https://hub.docker.com/r/hummingbot/hummingbot/tags?name=version-1.15.0-arm)
...
Hummingbot CTO `Fede` has published a new video - `How to Use Streamlit Apps`, and also introduced the new Hummingbot Dashboard which shows General Stats, Bot Performance, Trading chart, Orders, & Trades. This week the new version of Streamlit Apps will be released and you will be able to see your bot's performance!


## CandlesFeed Improvements and New Script to download candles feed

**Pull Request:** [#6190](https://github.com/hummingbot/hummingbot/pull/6190)

We improved the [CandlesFeed](/scripts/candles-feed) Smart Component introduced in the last release:

* Improvement in the collection of candles via rest to allow processing of WebSocket messages while the fill historical candles task is collecting the missing candles via rest.

* Also a script with an example of how to download historical candles is provided (see below)
...
## New PERP CLOB CEX Connector: `bit_perpetual`

**Pull Requests:** [#6154](https://github.com/hummingbot/hummingbot/pull/6154)
...
## New SPOT CLOB CEX Connector: `hotbit`

**Pull Requests:** [#6140](https://github.com/hummingbot/hummingbot/pull/6140)
...
## New PERP CLOB DEX Connector: `injective_perpetual`
...
See the [Injective Perpetual](/exchanges/injective-perpetual/) connector documentation for more information.

**Thanks to [CoinAlpha](https://github.com/coinalpha) for this contribution! 🙏**


## New SPOT DEX Connector: `zigzag`

**Pull Requests:** [#0089](https://github.com/hummingbot/gateway/pull/0089)
