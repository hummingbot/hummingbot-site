...
We improved the [Candles Feed](../v2-strategies/candles/index.md) Smart Component introduced in the last release. Specifically, we improved the collection of candles via REST to allow processing of WebSocket messages while the fill historical candles task is collecting the missing candles via REST.

## New Script Examples

This release added the following new [Script](../scripts/index.md) examples:
...
* [Injective Chain (removed)](../gateway/chains.md)
