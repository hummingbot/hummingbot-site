...
Explore [Hummingbot Academy](../academy/index.md) to enhance your trading skills and knowledge!
...
Dive into the documentation at [V2 Strategies](../strategies/v2-strategies/index.md) to explore the full potential of these new strategies!
...
See [FoxBit](../exchanges/foxbit/index.md) for the exchange connector docs.
