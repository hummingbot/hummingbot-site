...
* [#6285](https://github.com/hummingbot/hummingbot/pull/6285) Fixed issue where [Phemex](/exchanges/phemex) funding payments were not reported **Thanks to [CoinAlpha](https://github.com/coinalpha) for this fix! 🙏**
