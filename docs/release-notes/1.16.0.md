...
In the last Community Call, Mike discussed the highlights from the v1.15.0 release, the new Bounties initiative, & community member TheHolyRoger presented Phase 2 of the [Orchestration Module](../installation/index.md):
...
* [Sponsors](../bounties/index.md)

## New Script Examples

This release added the following new [Script](../scripts/index.md) examples and improvements to existing ones:
...
See [Algorand](../gateway/chains.md) for the chain docs and the Tinyman exchange connector docs.
...
* [#6236](https://github.com/hummingbot/hummingbot/pull/6236) Fixed the issue where failure occurred in fetching trading fees when the number of trading symbols exceeded 10 on the [Kucoin](../exchanges/kucoin/index.md) exchange. **Thanks to [riven314](https://github.com/riven314) for this fix! 🙏**
...
* [#0092](https://github.com/hummingbot/gateway/pull/0092) Updated [Injective](../exchanges/injective.md) dependencies and removed deprecated code **Thanks to [CoinAlpha](https://github.com/coinalpha) for this fix! 🙏**
* [#0098](https://github.com/hummingbot/gateway/pull/0098) Deprecated the [Dexalot](../exchanges/dexalot.md) API key **Thanks to [CoinAlpha](https://github.com/coinalpha) for this fix! 🙏**
* [#0099](https://github.com/hummingbot/gateway/pull/0099) Updated the [BNB](../gateway/chains.md) tokenlist with data from the tokenlist used by [Pancakeswap](../exchanges/gateway/pancakeswap.md) **Thanks to [CoinAlpha](https://github.com/coinalpha) for this fix! 🙏**
