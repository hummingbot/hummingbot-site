...
* Extensive comments in the strategy code files: arbitrage, [cross exchange market making](https://github.com/hummingbot/hummingbot/blob/master/hummingbot/strategy/cross_exchange_market_making), and discovery
