...
* [OKX Perpetual](../exchanges/okx/index.md): New connector to OKX perpetual futures markets. See pull request [#6848](https://github.com/hummingbot/hummingbot/pull/6848) and **thanks to [tomasgaudino](https://github.com/tomasgaudino) for this contribution! 🙏**
...
For more information, see the **Osmosis** and [Chain Connectors - Osmosis](../gateway/chains.md) for the respective DEX and chain documentation pages.
...
* [Dexalot](../blog/posts/using-dexalot-with-hummingbot/index.md)
* Vega
* Osmosis
