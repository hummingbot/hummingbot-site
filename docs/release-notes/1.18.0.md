...
[Candles Feed](/scripts/candles-feed/) helps you generate custom OHLCV candles using both historical and live Websocket data, and create real-time custom technical indicators using `pandas_ta`. We have added support for `ascendex`:
