...
See the [Quants Lab Documentation](../quants-lab/index.md) for detailed information and installation guide.

### 🥞 PancakeSwap Connector

We have refactored and restored the [PancakeSwap](../exchanges/gateway/pancakeswap.md) connector to Gateway, enabling trading and liquidity provision using the modernized Gateway architecture on the largest DEX on BNB Chain and other EVM networks.
...
See the [RPC Provider Configuration Guide](../gateway/rpc.md) for detailed setup instructions and supported networks.
