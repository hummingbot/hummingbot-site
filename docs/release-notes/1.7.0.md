...
Now, the [`cross exchange market making` strategy](../strategies/cross-exchange-market-making.md) now has an option to use DEXes as taker exchanges. Now, you can hedge your filled orders on any [Gateway-supported AMM](../gateway/index.md)!

## New Script examples

We have added more [examples](https://github.com/hummingbot/hummingbot/tree/master/scripts) of [Scripts](../scripts/index.md) for the upcoming [Hummingbot BotCamp](https://www.botcamp.xyz/) developer bootcamp.
...
- Improved Gateway [developer setup docs](../developers/gateway-connectors/index.md)
- New Gateway [testing docs](../developers/gateway-connectors/testing.md)
