...
The **Volatility Screener** script in Hummingbot conducts a detailed analysis of market volatility for multiple cryptocurrency pairs on a specified exchange, utilizing various metrics and indicators like percentage changes, Bollinger Bands, and standard deviation calculations. The script is designed to provide periodic reports, making it a useful tool for traders looking to understand and capitalize on market volatility.
...
In a landmark collaboration, the **Hummingbot Foundation** has partnered with Hyperliquid to integrate these innovations into Hummingbot's ecosystem. This partnership is a strategic move to leverage Hyperliquid's advanced capabilities, such as one-click trading and near-instant transactions, thus enhancing the trading experience for Hummingbot users. Through this collaboration, we are excited to offer our community a sophisticated and dynamic trading experience that aligns with the rapid evolution of decentralized finance.
...
**A special thanks to [yancong001](https://github.com/yancong001) for their significant contribution to this integration! 🙏**


## New DEX Connector: XRPL Ledger
...
See [XRPL](../exchanges/xrpl.md) for the exchange connector docs.
