...
Ever since we introduced [Scripts](../strategies/scripts/index.md) as a lightweight way to create simple trading strategies, users have been asking for the ability to add configuration files for them, as they are able to do for V1 Strategies. Now, they finally can!
...
See [Config Files](../client/config-files.md#script-config-files) for details on how to use this feature.

## New Sample V2 Strategies

Hummingbot's new [V2 Strategies](../strategies/v2-strategies/index.md) allow users to create powerful custom strategies by configuring LEGO-like components as building blocks. In this release, we have added a page with a list of [Sample Strategies](../strategies/v2-strategies/examples/index.md) that users can extend and modify.
