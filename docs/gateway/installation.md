...
!!! tip "New: Manage Gateway via Hummingbot API"
    **If you installed Hummingbot using the [Condor Quickstart](../installation/condor.md)**, you can manage Gateway directly through the API - no separate installation needed!
