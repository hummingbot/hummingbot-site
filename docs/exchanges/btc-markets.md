...
Access the [Paper Trade](../global-configs/paper-trade.md) version of this connector by running `connect btc_markets_paper_trade` instead of `connect btc_markets`.
