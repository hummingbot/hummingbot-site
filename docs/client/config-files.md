...
Starting in v1.24.0, [Scripts](../scripts/index.md) can define a `ScriptConfig` class that defines configuration parameters that users can store in a YAML file.
...
The StrategyV2 framework abstracts strategy logic into [Controllers](../v2-strategies/controllers/index.md). Each controller defines the config parameters that it accepts.
