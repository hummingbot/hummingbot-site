...
- [Hummingbot Client from Source](../client/installation.md) - Install the core trading client for development
- [Gateway from Source](../gateway/installation.md#install-from-source) - Install the DEX connector middleware for development
